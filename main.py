...
notes_win.setStyleSheet('background-color:coral; color:red;font-size:15px')
...
button_note_create.setStyleSheet('background-color:yellow;')
button_note_del.setStyleSheet('background-color:yellow')
button_note_save.setStyleSheet('background-color:yellow')
...
button_tag_add.setStyleSheet('background-color:yellow')
button_tag_del.setStyleSheet('background-color:yellow')
button_tag_search.setStyleSheet('background-color:yellow')
